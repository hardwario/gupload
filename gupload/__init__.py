...
@click.option('-f', '--file', 'files', nargs=2, type=click.Tuple([str, click.File('rb')]), multiple=True, help='Input file(s) to be uploaded.', metavar='<NAME PATH>...')
    ...
    try:
        ...
        for name, file in files:
            ...
            if folder is not None:
                body['parents'] = [folder]
            media_body = apiclient.http.MediaIoBaseUpload(file, mimetype='application/octet-stream')
